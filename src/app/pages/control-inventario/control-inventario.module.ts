...
import { ControlInventarioRoutingModule } from './control-inventario-routing.module';
import { ControlInventarioListComponent } from './components/control-inventario-list/control-inventario-list.component';
import { ControlInventarioManageComponent } from './components/control-inventario-manage/control-inventario-manage.component';
...
@NgModule({
  declarations: [
    ControlInventarioListComponent,
    ControlInventarioManageComponent
  ],
  imports: [
    CommonModule,
    ControlInventarioRoutingModule,
    SharedModule,
    ListTableComponent,
...
export class ControlInventarioModule { }
